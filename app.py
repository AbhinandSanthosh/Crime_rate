...
# Page config (wide layout for better form spacing)
st.set_page_config(
...
# Custom CSS for attractiveness (dark theme enhancements)
st.markdown("""
    <style>
...
def load_encoders():
    try:
        ...
        st.warning("encoders.pkl not found. Unseen categories will be mapped to default.")
        return None
...
# Header image (optional: add a image file to your folder)
...
with tab_single:
    ...
    if submitted:
        with st.spinner("Analyzing case..."):
            ...
            with st.expander("View engineered features"): st.dataframe(X)
